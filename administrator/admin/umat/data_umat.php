            ...
            <table id="example1" class="table table-bordered table-striped">
			  ...
			  left join tb_kk k on a.id_kk=k.id_kk left join tb_lingkungan c on p.id_lingkungan=c.id_lingkungan left join tb_stasi d on c.id_stasi=d.id_stasi inner join tb_kub b on p.id_kub=b.id_kub where status_umat='Ada'");
                    ...
                    <tr>
                        ...
                        <input hidden type="date" class="form-control" id="tanggal_lahirA"
                        ...
                        <td>
                            <a href="?page=view-umat&kode=<?php echo $data['id_umat']; ?>" title="Detail"
                                class="btn btn-info btn-sm">
                                <i class="fa fa-user"></i>
                            </a>
                            <a href="?page=edit-umat&kode=<?php echo $data['id_umat']; ?>" title="Ubah"
                                class="btn btn-success btn-sm">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a href="?page=del-umat&kode=<?php echo $data['id_umat']; ?>"
